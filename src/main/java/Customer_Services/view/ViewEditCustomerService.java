...
public class ViewEditCustomerService implements Menu {
	...
	public ViewEditCustomerService(HashMap<String, String> data, String userName) {
		this.data = data;
	...
	public HashMap<String, ArrayList<String>> getMenu() {
        ...
        System.out.println(this.userName+"\t EditCustomerResponse");
        System.out.println(this.line);
